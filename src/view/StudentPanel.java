...
//		gbl_contentPane.rowWeights = new double[]{Double.MIN_VALUE};
		...
		lblNewLabel_2 = new JLabel("Gestión de estudiantes");
		...
		btnPrevious.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				loadRecord(StudentController.getPrevious(Integer.parseInt(jtfId.getText())));
			}
		});
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				loadRecord(StudentController.getNext(Integer.parseInt(jtfId.getText())));
			}
		});
		panel.add(btnNext);
	...
	private void loadRecord(Student s) {
		if (s != null) {
			...
			jtfFirstSurname.setText(s.getFirstSurname());
			jtfSecondSurname.setText(s.getSecondSurname());
			jtfDni.setText(s.getDni());
			jtfAddress.setText(s.getAddress());
			jtfEmail.setText(s.getEmail());
			jtfPhone.setText(s.getPhone());
		}
		if (StudentController.getPrevious(Integer.parseInt(jtfId.getText())) == null) {
		...
		if (StudentController.getNext(Integer.parseInt(jtfId.getText())) == null) {
	...
	private void saveRecord() {
		...
		s.setFirstSurname(jtfFirstSurname.getText());
		s.setSecondSurname(jtfSecondSurname.getText());
		s.setDni(jtfDni.getText());
		s.setAddress(jtfAddress.getText());
		s.setEmail(jtfEmail.getText());
		s.setPhone(jtfPhone.getText());
